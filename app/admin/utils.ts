...
export const normalizarTexto = (valor?: string | number | null) =>
  String(valor ?? "").trim().toLowerCase()

export const limpiarNumeroContacto = (valor?: string | null) =>
...
export const descargarArchivoTexto = (
...
export const formatearSoles = (valor: number) =>
